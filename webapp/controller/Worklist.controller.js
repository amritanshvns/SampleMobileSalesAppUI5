sap.ui.define([
	...
	return BaseController.extend("technophilia.MobileSalesApp.controller.Worklist", {
		...
		onCreatePromotions: function(){
			this.oView = this.getView();
			this.createDialog = sap.ui.xmlfragment(this.oView.getId(), "technophilia.MobileSalesApp.fragments.CreatePromotion", this);
			this.oView.addDependent(this.createDialog);
			this.getView().byId("createPromotionSubmit").setEnabled(false);
			this.createDialog.attachAfterClose(function() {
				this.destroy();
			});
			this.createDialog.setModel(this.oModel);
			this.createDialog.open();
		},
		onCreatePromotion : function() {
			this.createDialog.destroy();
		},
		onCancelCreatePromotion : function() {
			this.createDialog.destroy();
		}
	});
});
